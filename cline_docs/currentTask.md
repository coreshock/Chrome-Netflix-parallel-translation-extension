...
## Next Steps
- [x] Implement ARD subtitle detection and extraction logic in `src/subtitle-detection.js` using my working and tested example from \code_examples\ard\detection_example_code.js and \code_examples\ard\extraction_example_code.js
- [x] Update translation function in `src/translate.js` to handle ARD subtitles.
- [x] Integrate ARD subtitles detection, translation and ARD page injection in `src/content.js`